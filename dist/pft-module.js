...
PFT.tester = {
    ...
    /**
     * function throws an exception to jump out of currently executing section
     * and prevent further lines of the script from being run
     */
    /** @ignore */
    haltCurrentScript: function () {
    ...
    handleError: function (msg) {
        ...
        // halt current step and go to next
        var t = PFT.tester.currentTest();
        if (!t.halt) {
            // unexpected exception so log as error
            t.errors.push(msg);
